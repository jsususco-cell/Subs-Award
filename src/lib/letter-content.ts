...
export const LETTER_INTRO =
  "Por medio de la presente, Byrdson Services, LLC, (en adelante, CM) le notifica que ha sido adjudicado como Subcontratista, para la ejecución de los trabajos relacionados al caso identificado a continuación, conforme a los términos de este documento, el Master Service Agreement vigente entre las partes, y los Términos y Condiciones aplicables, los cuales forman parte integral de este Subcontrato.";

export const MOBILISATION_NOTE =
  "El pago de Movilización está limitado a un máximo de diez mil dólares ($10,000.00), independientemente del Monto Total adjudicado. Cada pago corresponde únicamente a la etapa completada, verificada e inspeccionada.";
...
export interface LetterLabels {
  ...
  sectionCase: string;
  sectionAward: string;
  /** Heading where the award is one agreed figure rather than a derivation. */
...
export const PR_LABELS: LetterLabels = {
  ...
  sectionContract: "Precio Total del Contrato",
 ...
 */
export const LETTER_TEMPLATES: Partial<
  Record<LetterTemplateKey, LetterTemplate>
> = {
  "pr-es": PR_LETTER,
  "us-en": US_LETTER,
};
